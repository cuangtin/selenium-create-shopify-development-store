...
try:
    ...
    submitButton.click()
    print("Create store processing... ~ 35s")
except:
...
try:
    ...
    formAddStaff.send_keys_to_element(driver.find_element(By.CSS_SELECTOR, 'input[name="firstName"]'), customerName)
